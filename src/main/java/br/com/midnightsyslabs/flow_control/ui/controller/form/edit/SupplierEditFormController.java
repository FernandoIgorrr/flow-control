...
public class SupplierEditFormController {
    ...
    public SupplierEditFormController(
    ...
    public void loadClientData() {
        ...
        if (supplierDTO.getCategory() == PartnerCategory.PERSONAL) {
            personalPartnerRepository.findById(supplierDTO.getId()).ifPresentOrElse(client -> {
            ...
            companyPartnerRepository.findById(supplierDTO.getId()).ifPresentOrElse(client -> {
            ...
            if (supplierDTO != null) {
                ...
                if (supplierDTO.getCategory() == PartnerCategory.PERSONAL) {
                    personalPartnerRepository.findById(supplierDTO.getId()).ifPresentOrElse(client -> {
                        ...
                        supplierService.updatePersonalSupplier(
                                client,
                                nameField.getText(),
                                document,
                                phone,
                    ...
                    companyPartnerRepository.findById(supplierDTO.getId()).ifPresentOrElse(client -> {
                        supplierService.updateCompanySupplier(
                                client,
                                nameField.getText(),
                                document,
                                phone,
